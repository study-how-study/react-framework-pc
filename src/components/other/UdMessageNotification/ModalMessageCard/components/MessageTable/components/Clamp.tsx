...
export default class ClampLines extends PureComponent<any, any> {
  element: any;
  original: any;
  watch: boolean;
  lineHeight: number;
  ...
  ssr: boolean;
  debounced: () => void;
  static propTypes: { text: PropTypes.Validator<string>; lines: PropTypes.Requireable<number>; ellipsis: PropTypes.Requireable<string>; buttons: PropTypes.Requireable<boolean>; moreText: PropTypes.Requireable<string>; lessText: PropTypes.Requireable<string>; className: PropTypes.Requireable<string>; delay: PropTypes.Requireable<number>; stopPropagation: PropTypes.Requireable<boolean>; innerElement: PropTypes.Requireable<string>; };
  static defaultProps: { lines: number; ellipsis: string; buttons: boolean; moreText: string; lessText: string; delay: number; innerElement: string; };
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    const iClampElement = React.cloneElement(innerClampElement, {
